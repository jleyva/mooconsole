...
class MyMainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.notebook_reports = wx.Notebook(self.notebook_1_pane_5, -1, style=0)
        ...
        self.sizer_50_staticbox = wx.StaticBox(self.notebook_1_pane_2, -1, "Preferences")
        self.sizer_32_staticbox = wx.StaticBox(self.notebook_1_pane_4, -1, "Choose files to upload")
        self.sizer_31_staticbox = wx.StaticBox(self.notebook_1_pane_4, -1, "Transfer queue:")
        ...
        self.label_login = wx.StaticText(self.notebook_1_pane_1, -1, "Login into the selected sites")
        ...
        self.button_open_idata = wx.Button(self.notebook_1_pane_3, -1, "Load data and run ws")
        self.label_15 = wx.StaticText(self.notebook_1_pane_3, -1, "Server response:")
        self.text_ctrl_ws_log = wx.TextCtrl(self.notebook_1_pane_3, -1, "", style=wx.TE_MULTILINE|wx.TE_READONLY)
        self.label_21 = wx.StaticText(self.notebook_1_pane_3, -1, "Grid response:")
        self.grid_ws = wx.grid.Grid(self.notebook_1_pane_3, -1, size=(1, 1))
        self.button_save_csv = wx.Button(self.notebook_1_pane_3, -1, "Save as spreadsheet")
        self.label_24 = wx.StaticText(self.notebook_1_pane_4, -1, "Only for Moodle 2 sites")
        self.list_ctrl_files = wx.ListCtrl(self.notebook_1_pane_4, -1, style=wx.LC_REPORT|wx.SUNKEN_BORDER)
        self.button_add_files = wx.Button(self.notebook_1_pane_4, -1, "Add")
        self.button_remove_files = wx.Button(self.notebook_1_pane_4, -1, "Remove")
        self.label_20 = wx.StaticText(self.notebook_1_pane_4, -1, "Destination:")
        self.text_ctrl_destination = wx.TextCtrl(self.notebook_1_pane_4, -1, "", style=wx.TE_READONLY)
        self.button_browse = wx.Button(self.notebook_1_pane_4, -1, "Browse Moodle Site")
        self.button_upload_files = wx.Button(self.notebook_1_pane_4, -1, "Upload Files")
        self.list_ctrl_uploading = wx.ListCtrl(self.notebook_1_pane_4, -1, style=wx.LC_REPORT|wx.SUNKEN_BORDER)
        ...
        self.button_save_report = wx.Button(self.notebook_1_pane_5, -1, "Save as spreadsheet")
    ...
    def __set_properties(self):
        ...
        self.label_24.SetForegroundColour(wx.Colour(255, 0, 0))
    ...
    def __do_layout(self):
        ...
        self.notebook_1_pane_3.SetSizer(sizer_22)
        sizer_30.Add(self.label_24, 0, 0, 0)
        ...
        self.notebook_1_pane_4.SetSizer(sizer_30)
        ...
        self.notebook_1_pane_5.SetSizer(sizer_8)
        self.notebook_1.AddPage(self.notebook_1_pane_1, "Main")
        self.notebook_1.AddPage(self.notebook_1_pane_2, "Sites configuration")
        self.notebook_1.AddPage(self.notebook_1_pane_3, "Web services")
        self.notebook_1.AddPage(self.notebook_1_pane_4, "File uploader")
        self.notebook_1.AddPage(self.notebook_1_pane_5, "Reports")
